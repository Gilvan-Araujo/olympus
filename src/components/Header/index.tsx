...
export function Header() {
  return (
    <div className="flex flex-row items-center justify-between">
      ...
      <div className="flex items-center justify-between gap-4 xl:gap-6 2xl:gap-9">
        <Clock />
        ...
        <svg
          ...
          fill="#000000"
          viewBox="0 0 256 256"
          className="size-5 fill-white xl:size-6 2xl:size-8"
        >
        ...
        <div className="flex items-center justify-center gap-2 xl:gap-3">
          <p className="text-base xl:text-xl 2xl:text-2xl">100%</p>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="#000000"
            viewBox="0 0 256 256"
