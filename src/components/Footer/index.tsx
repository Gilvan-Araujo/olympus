export function Footer() {
  return (
    <div className="flex flex-row items-center justify-between border-t px-9 pt-3 2xl:border-t-2 2xl:px-14 2xl:pt-4">
      <div className="flex flex-col items-center gap-1 2xl:gap-2">
        <div className="flex flex-row items-center justify-between gap-1 2xl:gap-2">
          <div className="size-2 bg-green 2xl:size-3" />
          <div className="size-[0.375rem] bg-gray 2xl:size-2" />
          <div className="size-[0.375rem] bg-gray 2xl:size-2" />
          <div className="size-[0.375rem] bg-gray 2xl:size-2" />
        </div>
        <svg
          ...
          fill="#000000"
          viewBox="0 0 256 256"
          className="size-11 fill-white 2xl:size-16"
        >
      ...
      <div className="flex flex-row gap-11 2xl:gap-16">
        <a
        ...
        >
          ...
          <p className="text-xl 2xl:text-2xl">gilvan-araujo-jr</p>
        </a>
        ...
        >
          ...
          <p className="text-xl 2xl:text-2xl">gilvanjunior@pm.me</p>
        </a>
        ...
        <span className="flex flex-row items-center gap-3 2xl:gap-4">
          ...
          <p className="text-xl 2xl:text-2xl">+55 (83) 9 9648-1242</p>
        </span>
      </div>
    </div>
  );
